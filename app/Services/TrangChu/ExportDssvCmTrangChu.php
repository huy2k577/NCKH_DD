...
class ExportDssvCmTrangChu implements FromCollection, WithHeadings,WithEvents
{   
   ...
   public function registerEvents(): array
{
    return [
        ...
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->getStyle('A1:L2')->getFont()->setBold(true);// Im đậm
            $sheet->getStyle('A1')->getFont()->setSize(14); // cỡ chữ 


            // 👉 cách 2 dòng dưới bảng
            // $startRow = $highestRow + 3;

            // // Ghi nội dung
            // $sheet->setCellValue('I' . $startRow, 'Phân công coi thi');
            // $sheet->setCellValue('I' . ($startRow + 1), '(Ký, ghi rõ họ tên)');
            
            // $sheet->mergeCells('I' . $startRow . ':I' . ($startRow + 1)); 

            // // 👉 in đậm + căn giữa
            // $sheet->getStyle('I' . $startRow . ':K' . ($startRow + 1)) //I20:K21
            //     ->getAlignment()// căn lề giữa
